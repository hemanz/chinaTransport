...
-(void)createUI{
    cityLabel = [MyControl createLabelWithtext:nil font:16 textcolor:RGBCOLOR(68, 68, 68) backgroundColor:nil];
    [self.contentView addSubview:cityLabel];
    _carNumField = [[UITextField alloc] init];
    _carNumField.delegate =self;
    _carNumField.returnKeyType =UIReturnKeyDone;
    _carNumField.font = [UIFont systemFontOfSize:14];
...
//        make.top.equalTo(self.contentView).with.offset(20);
//        make.left.greaterThanOrEqualTo(cityLabel.mas_right).with.offset(29);
