...
- (void)createView{
    _leftTableView.frame = CGRectMake(0, 0, SIZE.width, SIZE.height-64);
    _centerTableView.frame = CGRectMake(SIZE.width, 0, SIZE.width, SIZE.height-64);
    _rightTableView.frame = CGRectMake(SIZE.width*2, 0, SIZE.width, SIZE.height-64);
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    DrivingModel *model = [self getAnswerModel:tableView];
    UIFont *font = [UIFont systemFontOfSize:(CGFloat)14];
    CGFloat height = [self getSizeWithString:model.explains withFont:font withSize:CGSizeMake(SIZE.width-20, 0)].height+60;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if (scrollView.contentOffset.x >0){
        ...
        if (page<_dataArray.count - 1&&page>0) {
            ...
            _centerTableView.frame = CGRectMake(currentOffset.x, 0, SIZE.width, SIZE.height-64);
            _leftTableView.frame = CGRectMake(currentOffset.x - SIZE.width, 0, SIZE.width, SIZE.height-64);
            _rightTableView.frame = CGRectMake(currentOffset.x + SIZE.width, 0, SIZE.width, SIZE.height-64);
        }
        _currentPage = page;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat height = [self getSizeWithString:drivingAnswerModel.answerContent withFont:font withSize:CGSizeMake(wid-60,0)].height;
...
-(BOOL)updateExamData:(DrivingModel *)drivingModel{
    ...
    [dbmanager updateIsRead:drivingModel];
