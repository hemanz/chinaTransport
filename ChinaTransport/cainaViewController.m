...
- (void)viewDidLoad {
    ...
    dataTableView  = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, wid, heigh/2) style:UITableViewStylePlain];
...
//    UIView *headerView =[[UIView alloc] initWithFrame:CGRectMake(0, 0, wid, 40)];
//    UILabel *headerTitleLabel =[[UILabel alloc]initWithFrame:CGRectMake(20, 10, 100, 20)];
//    headerTitleLabel.text =@"实时路况";
//    headerTitleLabel.textColor=RGBCOLOR(51, 51, 51);
//    [headerView addSubview:headerTitleLabel];
//    headerView.backgroundColor = RGBCOLOR(234, 235, 230);
//    return headerView;
//}
