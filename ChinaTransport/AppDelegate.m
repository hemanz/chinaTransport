...
-(void)pregoHomeController{
    NSArray *navigationPicArray =@[@"引导页新1",@"引导页新1",@"引导页新1"];
//          滑动的scrollView
...
//        可以直接点击进入的Button
    UIButton *loginButton =[MyControl createButtonWithFrame:CGRectMake((wid/2-kNavigatPicWidth/2), heigh-80, kNavigatPicWidth, 35) title:nil titleColor:nil imageName:nil bgImageName:@"立即体验" target:self method:@selector(loginBtnClick)];
